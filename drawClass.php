...
Class Chart{
     ...
     */
    function __construct($title,$xdata,$ydata,$seriesName,$size,$title_file) {
        $this->title = $title;
        $this->xdata = $xdata;
        $this->ydata = $ydata;
...
/*
    ...
    public function paintLineChart() {
        ...
        // 输出图片
        // $img_url_name = microtime(true).'_'.rand(1000,9999);

        imagepng ( $this->image,"excel_images/".$this->title_file.".png");
        return "excel_images/".$this->title_file.".png";
    }
